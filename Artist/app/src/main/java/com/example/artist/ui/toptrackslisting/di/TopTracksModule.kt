...
import com.example.artist.ui.toptrackslisting.*
...
@Module
class TopTracksModule(var mView: TopTracksView) {

    // provides the view to create the top tracks presenter
    @Singleton
    @Provides
    fun providesTopTracksView(): TopTracksView {
        return mView
    }
    ...
    @Singleton
    @Provides
    fun providesTopTopTracksInteractor(retrofit: Retrofit): TopTracksInteractor {
        return TopTracksInteractorImpl(retrofit)
    }

    // provides top albums presenter
    @Singleton
    @Provides
    fun providesTopTracksPresenter(view: TopTracksView, interactor: TopTracksInteractor): TopTracksPresenter {
        return TopTracksPresenterImpl(view, interactor)
    }
