...
open class TopTracksAdapter(var mDataset: MutableList<Track>, var mContext: Context, var mOnItemClickListener: View.OnClickListener?) : RecyclerView.Adapter<TopTracksAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.trackImageView.let { loadImage(mContext, item.imageUrl, R.drawable.default_track, it) }
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        var trackImageView: ImageView = itemView.img_track
